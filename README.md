# cloud-itonami-iso3166-tur

Open ISO 3166 Blueprint for **TUR**: Republic of Türkiye.
...
tax registration, and local-content rules in Turkey, so the operator
...
- **Not the government of Turkey.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Turkish-licensed counsel
...
(ISO 3166 `TUR`). Required capabilities:
