(ns marketentry.store
  "SSoT for the TUR market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems TR" :portal "EKAP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-tr-entity? true :has-tr-entity? true
             :requires-vkn? true :vkn-verified? true
             :drafted? false :submitted? false
             :jurisdiction "TUR" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "EKAP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-tr-entity? true :has-tr-entity? true
             :requires-vkn? true :vkn-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "EKAP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "TUR" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "EKAP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-tr-entity? true :has-tr-entity? false
             :requires-vkn? true :vkn-verified? true
             :drafted? false :submitted? false
             :jurisdiction "TUR" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "EKAP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-tr-entity? true :has-tr-entity? true
             :requires-vkn? true :vkn-verified? false
             :drafted? false :submitted? false
             :jurisdiction "TUR" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "EKAP"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-tr-entity? has-tr-entity?
                               requires-vkn? vkn-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-tr-entity?)  (assoc :engagement/requires-tr-entity? requires-tr-entity?)
    (some? has-tr-entity?)       (assoc :engagement/has-tr-entity? has-tr-entity?)
    (some? requires-vkn?)    (assoc :engagement/requires-vkn? requires-vkn?)
    (some? vkn-verified?)    (assoc :engagement/vkn-verified? vkn-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-tr-entity? :engagement/has-tr-entity?
   :engagement/requires-vkn? :engagement/vkn-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-tr-entity? (boolean (:engagement/requires-tr-entity? m))
     :has-tr-entity? (boolean (:engagement/has-tr-entity? m))
     :requires-vkn? (boolean (:engagement/requires-vkn? m))
     :vkn-verified? (boolean (:engagement/vkn-verified? m))
